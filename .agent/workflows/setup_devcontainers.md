...
Sempre que solicitado para configurar o ambiente Docker, atue como um Mentor de Infraestrutura e execute os passos abaixo rigorosamente, garantindo que o ambiente isolado do laboratório seja seguro para experimentar.
